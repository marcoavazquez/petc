...
settings: {
    ...
    */
    errorMsg: 'Ha escrito una entrada no v&aacute;lida en el formulario',
    
    /** 
    * Default error message for the validateRequired validation
    * @default  'You have skipped a required field'
    */
    requiredErrorMsg: 'Dejaste algœn(os) campo(s) requerido(s) vac&iacute;o(s)',
    ...
    */
    minlengthErrorMsg: 'El campo no puede ser menor de {!minlength} caracteres',
    ...
    */
    maxlengthErrorMsg: 'El campo no puede ser mayor de {!maxlength} caracteres',
    
    /** 
    * Default error message for the validateCharacters function
    * @default  'You have entered invalid characters'
    */
    characterValidationErrorMsg: 'Ha escrito caracteres inv&aacute;lidos',
...
getDateTimeDefaultOptions: function ( options, defaults ) {
    ...
    if( typeof options.maxYear=='undefined' ) options.maxYear = new Date().getFullYear() + 0;
...
validateDate: function( text, options ) {
    //Set default values
    options = validanguage.getDateTimeDefaultOptions(options, {dateOrder: 'dmy'} );
...
validateFilePDF: function( text ) {
	extension = (text.substring(text.lastIndexOf("."))).toLowerCase();
    if( extension != ".pdf")
       return false;
    else return true;
},
